...
def get_gazelle_model(model_name: str, onnx_export: bool=False, finetune_backbone: bool=False, apply_sigmoid: bool=True):
    factory = {
        ...
        "gazelle_hgnetv2_atto_inout": lambda: gazelle_hgnetv2_atto_inout(
            weights_path="./ckpts/PPHGNetV2_B0_stage1.pth",
            use_lab=True,
            return_idx=[2],
            freeze_stem_only=True,
        ...
        "gazelle_hgnetv2_femto_inout": lambda: gazelle_hgnetv2_femto_inout(
            weights_path="./ckpts/PPHGNetV2_B0_stage1.pth",
            use_lab=True,
            return_idx=[2],
            freeze_stem_only=True,
        ...
        "gazelle_hgnetv2_pico_inout": lambda: gazelle_hgnetv2_pico_inout(
            weights_path="./ckpts/PPHGNetV2_B0_stage1.pth",
            use_lab=True,
            return_idx=[2],
            freeze_stem_only=True,
        ...
        "gazelle_hgnetv2_n_inout": lambda: gazelle_hgnetv2_n_inout(
            weights_path="./ckpts/PPHGNetV2_B0_stage1.pth",
            use_lab=True,
            return_idx=[2, 3],
            freeze_stem_only=True,
